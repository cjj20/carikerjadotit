...
Job.create!(title: "Team Lead Engineer (on-site)", salary_min: 32000, salary_max: 38000, salary_is_undisclosed: false,
            employment_type: 0, location_type: 0, is_new: true, experience_level: 2, type_of_work: 0, job_description: "Text",
            apply_link: "link", main_technology: "Python", online_interview: true,
            skills: ["Python", "Golang", "Team Leadership", "AWS", "Docker"],
...
Job.create!(title: "Data Integration Engineer with GCP", salary_min: 0, salary_max: 0, salary_is_undisclosed: true,
            employment_type: 0, location_type: 2, is_new: true, experience_level: 1, type_of_work: 0, job_description: "Text",
            apply_link: "link", main_technology: "Python", online_interview: true,
            skills: ["GCP", "SQL", "Python"],
...
Job.create!(title: "Junior Full Stack Engineer", salary_min: 2900, salary_max: 3750, salary_is_undisclosed: false,
            employment_type: 0, location_type: 0, is_new: true, experience_level: 0, type_of_work: 1, job_description: "Text",
            apply_link: "link", main_technology: "Python", online_interview: true,
            skills: ["Python", "Golang", "React", "Typescript", "Rest API"],
...
Job.create!(title: "IAM Automation Engineer)", salary_min: 0, salary_max: 0, salary_is_undisclosed: true,
            employment_type: 0, location_type: 2, is_new: true, experience_level: 2, type_of_work: 0, job_description: "Text",
            apply_link: "link", main_technology: "Java", online_interview: false,
            skills: ["Java", "Web Services", "SQL", "BeanShell", "IAM Concepts"],
...
Job.create!(title: "Junior Flutter Developer", salary_min: 9000, salary_max: 13000, salary_is_undisclosed: false,
            employment_type: 0, location_type: 2, is_new: true, experience_level: 0, type_of_work: 0, job_description: "Text",
            apply_link: "link", main_technology: "Mobile", online_interview: true,
            skills: ["English", "Flutter", "Dart"],
